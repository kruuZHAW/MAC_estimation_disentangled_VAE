...
from deep_traffic_generation.core import TCN, IBP_VAE, cli_main
from deep_traffic_generation.core.datasets import DatasetParams, TrafficDatasetPairs, TrafficDatasetPairsRandom 
from deep_traffic_generation.core.lsr import IBP_LSR
...
longitude
    ...
    _required_hparams = IBP_VAE._required_hparams + [
        "sampling_factor",
        "kernel_size",
        "dilation_base",
        "alpha0",
    ...
    def __init__(
        ...
        self.lsr = IBP_LSR(
            input_dim=2*h_dim,
            max_trunc=self.hparams.encoding_dim,
            alpha0=self.hparams.alpha0,
        )
    ...
    def add_model_specific_args(
        ...
        parser.add_argument(
            "--alpha0", dest="alpha0", type=int, default=5
        )
...
if __name__ == "__main__":
    cli_main(IBP_TCVAE_Pairs, TrafficDatasetPairsRandom, "image", seed=42)